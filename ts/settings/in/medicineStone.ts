...
import { medicineStonePullWrite } from "../../first/converter/medicineStoneWrite";
...
export const medicineStone: UqInTuid = {
    uq: 'platform/Push',
    type: 'tuid',
    ...
    pull: pullSql,
    pullWrite: medicineStonePullWrite,
    firstPullWrite: medicineStonePullWrite,
};