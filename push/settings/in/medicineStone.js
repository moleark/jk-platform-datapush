...
exports.medicineStone = void 0;
const config_1 = __importDefault(require("config"));
const medicineStoneWrite_1 = require("../../first/converter/medicineStoneWrite");
...
let pullSql = `SELECT TOP ${promiseSize} r.ID, m.name AS Brand, p.OriginalID, ISNULL(p.LotNumber, '') AS mdl, zcl_mess.dbo.fc_reCAS(p.CAS) AS CasFormat,  p.Description,
                ...
                WHERE r.CustomerUnitOnPlatformId = 'd1369ed10cf54991a36d9663940eb414'
                    AND r.Id > @iMaxId
                ORDER BY Id;`;
exports.medicineStone = {
    uq: 'platform/Push',
    type: 'tuid',
    entity: 'medicineStone',
    key: 'ID',
    mapper: {
        $id: 'ID',
        brandName: "Brand",
    ...
    pull: pullSql,
    pullWrite: medicineStoneWrite_1.medicineStonePullWrite,
    firstPullWrite: medicineStoneWrite_1.medicineStonePullWrite,
};
//# sourceMappingURL=medicineStone.js.map